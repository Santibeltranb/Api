import {
  ...
  import { IconPlus } from '../../../../shared/icons/icons/plus';
  ...
  @Component({
    ...
    template: `
      <div class="flex items-center gap-x-4">
        ...
        />
        <a
          class="text-sm flex text-nowrap items-center gap-x-2 hover:text-green-400 transition-[color] ease-in-out duration-200 p-4 cursor-pointer"
